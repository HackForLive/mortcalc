...
def calculate_morgage(event):
    ...
    """
    interest_rate = document.querySelector("#interest_rate")
    loan_years = document.querySelector("#loan_years")
    principal_amount = document.querySelector("#principal_amount")


    ir = float(interest_rate.value)
    n = int(loan_years.value)
    principal = float(principal_amount.value)
